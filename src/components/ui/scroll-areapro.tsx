          ...
          >
            <motion.div
              animate={{
                ...
                backgroundColor: isScrolling ? '#2FAE63' : '#DDD6E3',
              }}
      ...
      <AnimatePresence>
        {showProgress === 'vertical' && isScrollingY && containerHeight > 0 && (
          ...
          >
            ...
            >
              <motion.div
                initial={{ backgroundColor: '#2FAE63', borderColor: '#258C50' }}
                animate={{
                  backgroundColor:
                    verticalScrollProgress.get() > 0 ? 'white' : '#2FAE63',
                  borderColor:
                    verticalScrollProgress.get() > 0 ? 'white' : '#258C50',
                }}
                transition={{ duration: 0.2, delay: 0.5 }}
            ...
            >
              ...
              <defs>
                <motion.linearGradient
                  ...
                  y2={y2}
                >
                  <stop stopColor='#2FAE63' stopOpacity='0' />
                  <stop stopColor='#2FAE63' />
                  <stop offset='0.5' stopColor='#258C50' />
                  <stop offset='1' stopColor='#8B8295' stopOpacity='0' />
                </motion.linearGradient>
              </defs>
            </svg>
          </motion.div>
